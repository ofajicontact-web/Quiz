...
export const MOROCCAN_QUESTIONS: Question[] = [
    ...
    },
    {
        ...
        level: 3,
        question: { fr: "Quel gouverneur marocain a mené la conquête de l’Andalousie en 711 ?", en: "Which Moroccan governor led the conquest of Andalusia in 711?", es: "¿Qué gobernador marroquí dirigió la conquista de Andalucía en 711?", dr: "شكون هو الوالي المغربي لي قاد فتح الأندلس ف 711؟" },
    ...
    },
    {
        ...
        options: { fr: ["Bencherifs", "Al-Idrissi", "Mrini", "Skali"], en: ["Bencherifs", "Al-Idrissi", "Mrini", "Skali"], es: ["Bencherifs", "Al-Idrissi", "Mrini", "Skali"], dr: ["بنشريف", "الإدريسي", "المريني", "برادة"] },
        correctAnswer: { fr: "Bencherifs", en: "Bencherifs", es: "Bencherifs", dr: "بنشريف" },
    ...
    },
    {
        ...
        options: { fr: ["Bencherifs", "Bensouda", "Skali", "Tajamouti"], en: ["Bencherifs", "Bensouda", "Skali", "Tajamouti"], es: ["Bencherifs", "Bensouda", "Skali", "Tajamouti"], dr: ["بنشريف", "بن سودة", "صقلي", "التجموعتي"] },
        correctAnswer: { fr: "Bencherifs", en: "Bencherifs", es: "Bencherifs", dr: "بنشريف" },
